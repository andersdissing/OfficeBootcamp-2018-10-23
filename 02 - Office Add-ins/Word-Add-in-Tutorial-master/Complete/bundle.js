	...
	(function () {
	    ...
	    function insertTable() {
	        Word.run(function (context) {
	            ...
	            const tableData = [["Name", "ID", "Birth City"], ["Bob", "434", "Chicago"], ["Sue", "719", "Havana"]];
